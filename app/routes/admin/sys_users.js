...
router.post('/getDepartmentByCompany', protect,  asyncHandler(MainControllers.getDepartmentByCompany));

router.post('/getUserByDepartment', protect, authorize(collection,"getData"), asyncHandler(MainControllers.getUserByDepartment));
