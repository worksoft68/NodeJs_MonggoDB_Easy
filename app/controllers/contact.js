...
const pageTitleIndex = 'Contact Management';
...
// // end getAll ================================================================================================= =================================================================================================
	...
	searchGet: async function(req, res, next){
		...
		let item = {
			...
			phone : await ParamsHelpers.getParam(req.query, 'phone', ''),
			content_message : await ParamsHelpers.getParam(req.query, 'content_message', ''),
		};
		item = clean(item);
