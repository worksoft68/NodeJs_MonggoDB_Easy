...
const sys_usersModel= require(__path_models + 'sys_users');
...
const pageTitleIndex = 'Management Permissions';
...
module.exports = {
	...
	indexString: async function(req, res, next) {
		...
		// sys_users = await sys_usersModel.listItemForDropdown();
		// catalogue.push(sys_users);
...
// // end getAll ================================================================================================= =================================================================================================
	...
	searchGet: async function(req, res, next){
		...
		let catalogueString = JSON.stringify(catalogue);
		let item = {
			user_id : await ParamsHelpers.getParam(req.query, 'user_id', ''),
