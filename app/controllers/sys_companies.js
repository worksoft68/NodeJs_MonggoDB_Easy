...
const pageTitleIndex = 'Company List Management';
...
// // end getAll ================================================================================================= =================================================================================================
	...
	searchGet: async function(req, res, next){
		...
		let item = {
			...
			address : await ParamsHelpers.getParam(req.query, 'address', ''),
			email1 : await ParamsHelpers.getParam(req.query, 'email1', ''),
			phone_number1 : await ParamsHelpers.getParam(req.query, 'phone_number1', ''),
			note : await ParamsHelpers.getParam(req.query, 'note', ''),
			representative_name : await ParamsHelpers.getParam(req.query, 'representative_name', ''),
			link_facebook : await ParamsHelpers.getParam(req.query, 'link_facebook', ''),
			bank_account_number1 : await ParamsHelpers.getParam(req.query, 'bank_account_number1', ''),
			bank_name1 : await ParamsHelpers.getParam(req.query, 'bank_name1', ''),
